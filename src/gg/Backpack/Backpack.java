...
import gg.Styles.LblProperties;
  ...
  public Backpack open(HumanTrainer ht) {
    ...
    btnUse.addActionListener(e -> {
      ...
      new PokemonInPartyPanel()
        .open(
          ht.getPokeSlots(),
          ht.getCurrentPokemon(),
          poke -> {
            ht.useItem(poke, selectedItem);
          })
        .onPartyClose(onBackpackClose::foo);
    });
    ...
    GUIManager.addNewBackgroundImage(getClass().getSimpleName(), new ImageIcon("src/imagesUI/Pokeball.png").getImage());
